...
const CreateNew = (props) => {
  const {onClear:clearContent, ...content} = useField('text', 'content')
  const {onClear:clearAuthor, ...author} = useField('text', 'author')
  const {onClear:clearInfo, ...info} = useField('text', 'info')
